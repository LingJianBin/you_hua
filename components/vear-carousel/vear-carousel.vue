<template>
	<swiper class="image-container" :indicator-dots="true" previous-margin="45rpx" next-margin="45rpx" interval="3000" circular autoplay @change="swiperChange">
