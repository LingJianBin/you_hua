! function(t) {
	...
	var o = function(t) {
			t = t ? 1 : 0;
			try {
				return s(location.search.substr(t))
			} catch (r) {
				try {
					var e = document.URL,
						n = e.indexOf("?");
					if (n >= 0) return s(e.substr(n + t))
				} catch (r) {}
			}
			return ""
		},
	...
	t.exports = function f() {
		var t, e, n, r, o, i, a = arguments[0],
			...
			d = arguments.length,
			h = !1;
		for ("boolean" == typeof a && (h = a, a = arguments[1] || {}, l = 2), (null == a || "object" != typeof a &&
				"function" != typeof a) && (a = {}); l < d; ++l)
			if (null != (t = arguments[l]))
				for (e in t) n = p(a, e), a !== (r = p(t, e)) && (h && r && (s(r) || (o = c(r))) ? (o ? (o = !1, i = n && c(n) ?
					n : []) : i = n && s(n) ? n : {}, u(a, {
					name: e,
					newValue: f(h, i, r)
				})) : void 0 !== r && u(a, {
	...
	var r, o, i = n(1),
		...
		s = (r = document.referrer, o = location.href || document.URL, r = r.length > 512 ? r.substr(0, 512) : r, o = o.length >
			1024 ? o.substr(0, 1024) : o, ["referer=" + encodeURIComponent(r), "href=" + encodeURIComponent(o)].join("&"));
	t.exports = {
		type: a,
		send: function(t, e, n) {
			try {
	...
	t.exports = {
		add: function(t, e, n) {
			t && (t.addEventListener ? t.addEventListener(e, n, !1) : t.attachEvent ? t.attachEvent("on" + e, n) : t["on" +
				e] = n)
		},
	...
	function s(t, e) {
		for (var r = 0; r < t.length; r++) {
			...
			if (i) {
				...
				for (; a < o.parts.length; a++) i.parts.push(l(o.parts[a], e))
			} else {
				var c = [];
				for (a = 0; a < o.parts.length; a++) c.push(l(o.parts[a], e));
				n[o.id] = {
					id: o.id,
					refs: 1,
					parts: c
	...
	function l(t, e) {
		...
		if (e.singleton) {
			var l = c++;
			n = a || (a = f()), r = p(y, null, n, l, !1), o = p(y, null, n, l, !0)
		} else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL
			.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (s = document.createElement("link"),
				u = i(), s.rel = "stylesheet", u.appendChild(s), r = p(m, null, n = s), o = function() {
	...
	function() {
		...
		function str(t, e) {
			var n, r, o, i, a, c = gap,
				s = e[t];
			switch (s && "object" === (void 0 === s ? "undefined" : _typeof(s)) && "function" == typeof s.toJSON && (s = s.toJSON(
				t)), "function" == typeof rep && (s = rep.call(e, t, s)), void 0 === s ? "undefined" : _typeof(s)) {
				case "string":
					return quote(s);
				case "number":
				...
				case "object":
					...
					if (rep && "object" === (void 0 === rep ? "undefined" : _typeof(rep)))
						for (i = rep.length, n = 0; n < i; n += 1) "string" == typeof rep[n] && (o = str(r = rep[n], s)) && a.push(
							quote(r) + (gap ? ": " : ":") + o);
					else
						for (r in s) Object.prototype.hasOwnProperty.call(s, r) && (o = str(r, s)) && a.push(quote(r) + (gap ? ": " :
							":") + o);
					return o = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + c + "}" : "{" + a.join(",") +
						"}", gap = c, o
			}
		...
		"function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function() {
			...
			if (rep = e, e && "function" != typeof e && ("object" !== (void 0 === e ? "undefined" : _typeof(e)) || "number" !=
			...
			function walk(t, e) {
				...
				if (o && "object" === (void 0 === o ? "undefined" : _typeof(o)))
					for (n in o) Object.prototype.hasOwnProperty.call(o, n) && ((r = walk(o, n)) !== undefined ? o[n] = r : delete o[
						n]);
	...
	function a(t, e, n) {
		var o = "";
		if (arguments.length < 2 ? o = "[Msger] error 1" : "object" != (void 0 === t ? "undefined" : r(t)) ? o =
			"[Msger] error 2" : "string" != typeof e && (o = "[Msger] error 3"), o) throw new Error(o);
	...
	a.prototype.send = i ? function(t) {
		...
		i ? "addEventListener" in document ? window.addEventListener("message", e, !1) : "attachEvent" in document &&
			window.attachEvent("onmessage", e) : window.navigator[o + this.name] = e
	...
	if (!0 === window.__TencentCaptchaExists__) throw new Error(
		"\u8bf7\u52ff\u591a\u6b21\u5f15\u7528\u817e\u8baf\u9a8c\u8bc1\u7801\u7684\u63a5\u5165js");
	window.__TencentCaptchaExists__ = !0, __webpack_require__(21), __webpack_require__(11);
	var Messenger = __webpack_require__(12),
		domReady = __webpack_require__(23),
		btoa = window.btoa || __webpack_require__(24),
		extend = Object.assign || __webpack_require__(2),
		loadScript = __webpack_require__(25),
		eventListener = __webpack_require__(7),
		Executor = __webpack_require__(26),
		isIEVar = __webpack_require__(27),
		isElement = __webpack_require__(28),
		invisibleIframe = __webpack_require__(29),
		getScriptDomain = __webpack_require__(30),
	...
	var cdnDomain = "https://captcha.gtimg.com/1",
		grayscaleFrameJs = "/tcaptcha-frame.21565e83.js",
		...
		Captcha = function Captcha($btn, appid, _tcallback_, opts) {
			var bizState = void 0;
			if (isElement($btn))
				if (appid && "object" === (void 0 === appid ? "undefined" : _typeof(appid))) opts = appid, appid = null,
					_tcallback_ = null;
				else {
			...
			opts = opts || {}, opts.callback = _tcallback_ || opts.callback, opts.start = opts.start || noop, opts.end = opts.end ||
				noop;
			var readyCallback = "function" == typeof opts.ready ? opts.ready : noop;
			if (opts.ready = function(t) {
					readyCallback.call(this, t)
				}, opts.appid = appid || opts.appid, opts.bizState = bizState || opts.bizState, opts.fwidth = parseFloat(opts.fwidth) ||
				0, opts.sdkOpts = opts.sdkOpts || null, opts.ele = $btn, this.options = opts, "function" != typeof opts.callback)
				throw new Error("Lost `callback`");
	...
	Captcha.prototype = {
		...
		__show__: function() {
			var t = this.initOpts;
			if ("undefined" == typeof window.AqSCode) return capError.send("ERROR_TYPE_FRAMEJS_CODE_ERROR", t.appid), alert(
				"\u9875\u9762\u52a0\u8f7d\u5f02\u5e38\uff0c\u8bf7\u5237\u65b0\u9875\u9762\u91cd\u8bd5");
			this.destroy();
			var e = [];
			for (var n in e.push("aid=" + t.appid), e.push("protocol=https"), e.push("accver=1"), e.push("showtype=" + t.type),
					e.push("ua=" + encodeURIComponent(btoa((navigator.userAgent || "").replace(/[\u00ff-\uffff]+/g, "")))), e.push(
						"noheader=" + ("" + t.showHeader == "false" ? "1" : "0")), e.push("fb=" + ("" + t.needFeedBack == "false" ?
						"0" : "1")), e.push("enableDarkMode=" + (t.enableDarkMode ? "1" : "0")), t.sid && e.push("sid=" + t.sid),
					preVerifyData) preVerifyData[n] && e.push(n + "=" + encodeURIComponent(preVerifyData[n]));
			t.uid = "" + (t.uin || ""), needGrayscaleJs && (e.push("grayscale=1"), t.grayscale = 1), isMobile ? (e.push(
					"clientype=1"), t.clientype = 1, t.forceLang && e.push("lang=" + t.forceLang), t.params = "?" + e.join("&")) :
				(e.push("clientype=2"), t.clientype = 2, needGrayscaleJs && t.forceLang && e.push("lang=" + t.forceLang), t.params =
					"?" + e.join("&"), t.s_type_suffix = "?" + e.join("&"), t.src = capDomain + "/template/new_placeholder.html" +
					t.s_type_suffix, t.s_type = capDomain + "/cap_union_prehandle" + t.s_type_suffix, t.slide_src = capDomain +
					"/template/new_slide_placeholder.html" + t.s_type_suffix, t.fb = "" + t.needFeedBack == "false" ? "0" : "1"),
				(capObj = new AqSCode(t)).listen(callbackWrap(this, t.callback), callbackWrap(this, t.ready)), capObj.start(
					callbackWrap(t.start)), capObj.end(callbackWrap(t.end)), needGrayscaleJs ? ((t.top || t.left) && capObj.initPos({
					top: t.top || undefined,
		...
		langFun: function() {
			if (this.initOpts.forceLang) {
				...
				t[e] ? (this.initOpts.lang = t[e], this.initOpts.forceLang = t[e], this.initOpts.forcestyle = 1) : this.initOpts
					.forceLang = ""
			}
		},
		destroy: function() {
	...
	executor.exec(function(t) {
		...
		needGrayscaleJs = !0, loadScript(grayscaleFrameJs, cdnDomain, capDomain, function() {
			return !!window.AqSCode
		}, function() {
			t()
		}, function() {
			capError.send("ERROR_TYPE_FRAMEJS_DOWNLOAD_FAIL"), t()
		})
	...
	t.exports = function(t) {
		...
		}, !1), i && r.attachEvent("onreadystatechange", e = function() {
	...
	var r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
		o = function(t) {
			...
			return [r.charAt(n >>> 18), r.charAt(n >>> 12 & 63), e >= 2 ? "=" : r.charAt(n >>> 6 & 63), e >= 1 ? "=" : r.charAt(
				63 & n)].join("")
		};
	t.exports = function(t) {
	...
	t.exports = function o(t, e, n, i, a, c, s) {
		...
		p.type = "text/javascript", p.async = !0, p.src = (s > 1 ? n : e) + t, "onload" in p ? p.onload = f : p.onreadystatechange =
			f;
		var l = function() {
			u || (u = !0, s >= r ? c && c() : o(t, e, n, i, a, c, s + 1))
		};
	...
	t.exports = function(t) {
		...
		return e.innerHTML = "\x3c!--[if IE " + t + "]><i></i><![endif]--\x3e", e.getElementsByTagName("i") && 1 === e.getElementsByTagName(
			"i").length
	}
}, function(t, e, n) {
	"use strict";
	...
	t.exports = function(t) {
		try {
			...
			return "object" === (void 0 === t ? "undefined" : r(t)) && 1 === t.nodeType && "object" === r(t.style) &&
	...
	t.exports = function(t) {
		...
		return e.src = t, e.style.cssText = "width: 0px; height: 0px; display: none;", (document.body || document.getElementsByTagName(
			"body").item("0")).appendChild(e), e
	}
}, function(t, e, n) {
	"use strict";
	var r = n(0).href,
