<template>
	<view class="container">
		...
		<view class="pic-box">
			...
			<view class="id">{{user.show_id}}</view>
			<view class="tip">
				保存二维码可分享
			</view>
...
<script>
	...
	export default {
		...
		onShow() {
			service.auth(this, service.api.me.friends, "GET", {}, (self, res) => {
				self.info = res.data
			})
		},
		methods: {
			...
			preview() {
				...
				context.fillText('邀请码', 187, 380)
				context.setFontSize(16)
				context.fillText(this.user.show_id, 187.5, 410)
				context.draw(false, () => {
