<template>
	<view class="container">
		...
		<view class="list-box" v-for="(item, index) in list" :key="index">
			...
			<view class="right" v-if="item.zyc < 0">{{item.zyc}}</view>
			<view class="right" v-else>+{{item.zyc}}</view>
		</view>
...
<script>
	...
	export default {
		...
		onReachBottom() {
			...
			service.auth(this, service.api.home.zycLog, "GET", {
